...
const styles = StyleSheet.create({
  ...
  detailCal: { color: Colors.accent, fontSize: 42, fontWeight: '800', marginVertical: 12 },
  ...
  notesBox: { backgroundColor: Colors.bgPrimary, borderRadius: 10, padding: 12, marginBottom: 16 },
  ...
  editBtn: {
    flex: 1, backgroundColor: Colors.bgElevated, borderRadius: 12,
    padding: 14, alignItems: 'center',
  },
  editBtnText: { color: Colors.textPrimary, fontWeight: '600' },
  deleteBtn: {
    flex: 1, backgroundColor: 'rgba(186, 26, 26, 0.12)', borderRadius: 12,
    padding: 14, alignItems: 'center',
  },
