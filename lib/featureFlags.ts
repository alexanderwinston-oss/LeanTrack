...
export const LEVEL_FEATURES = [
  ...
  { level: 3, name: 'Régulier', xp: 400,
    summary: 'Journal d\'hier complet (repas + eau)',
    detail: 'Ajoute, modifie ou supprime les repas et l\'eau d\'hier. Idéal si tu as oublié de logger en temps réel.' },
  ...
  { level: 5, name: 'Discipliné', xp: 1500,
    ...
    detail: 'Une nouvelle récompense arrive bientôt à ce palier.' },
